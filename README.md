...
Get notified when an agent's score drops below a threshold.
...
When the score drops below 0.7, AVP POSTs to your endpoint:
...
### Zero-config via environment variable
